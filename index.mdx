...
The storefront experience is yours to build: bring your own front end (web, mobile, an
...
The API spans **29 services across ~145 operations**, grouped by the job they do. A typical
storefront calls a handful of them.
