...
<Columns cols={2}>
  <Card title="Access and portability" icon="download">
    A merchant can export their own store's data — customers, orders, and the associated records — in a
    portable format, and can produce the data held about an individual customer to satisfy a request that
    customer makes to *them*.
  </Card>
