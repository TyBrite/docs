...
// returns { id: "c7f18400-eec6-448d-a599-cf871cf80b31", name: "Audio & Headphones",
...
// returns { subcategories: [ { id: 'shoes', name: 'Shoes', parent_id: null, ... } ], pagination: {...} }
const children = await client.taxonomy.listSubcategories({ parentId: 'shoes' });
// returns { subcategories: [ { id: 'mens', name: "Men's", parent_id: 'shoes', ... } ], pagination: {...} }
```
...
// returns "Computers › Laptops › Gaming Laptops"
```
...
// returns { products: [ { product_id, name, category_name: "Electronics", price, stock, ... } ],
...
// returns { products: [ { product_id: "2f571a46-e02a-44ea-9a68-0772381e6da2",
...
// returns { products: [...], pagination: {...} } — same row shape as above, scoped to both filters
```
