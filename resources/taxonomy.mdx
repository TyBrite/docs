...
Who decides a store's catalogue, and what can be changed after a store exists, is covered in
[White-Label](/resources/white-label#the-catalogue-an-operators-stores-start-with).
